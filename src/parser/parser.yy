...
%token CONCAT                    "concat aggregator"
...
arg
  ...
  | AT AT IDENT arg_list[exprs] COLON arg[first] COMMA aggregate_body
    {
      ...
      auto second = rest.size() > 1 ? std::move(rest[1]) : nullptr;
    ...
    /* -- aggregators -- */
  | aggregate_func arg_list COLON aggregate_body opt_orderby
    {
